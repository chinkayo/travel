    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3" id="buttonlist">
                <center>
                    <a href="detailwait"><button type="button" class="btn btn-default">審査待ち</button></br></br></a>
                    <a href="detailsuccess"><button type="button" class="btn btn-default">審査通過</button></br></br></a>
